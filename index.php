...
// ดึงข้อมูลผลิตภัณฑ์ด้วยการเตรียมคำสั่ง (prepared statements) เพื่อความปลอดภัย
...
<body>
    <div class="header">
        ...
        <div class="header-image">
            <img src="images/1212.jpg" alt="Header Image">
        </div>
        <div class="header-image">
            <img src="images/224.jpg" alt="Header Image">
        </div>
    </div>
    ...
    <footer class="footer">
        <div class="footer-content">
            <p>&copy; 2024 Game Account Store. All rights reserved.</p>
            <p>Contact us: <a href="mailto:support@gameaccountstore.com">support@gameaccountstore.com</a></p>
            <p>Follow us on 
